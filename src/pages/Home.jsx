            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
              ...
              >
                ...
                <motion.p
                  ...
                  transition={{ duration: 1 }}
                >
                  The Association for Computing Machinery (ACM) is the world's largest educational and scientific computing society, delivering resources that advance computing as a science and a profession. Our student chapter is dedicated to fostering a vibrant community of computer science enthusiasts. GSFC Univeristy ACM Student Chapter was established in May, 2024 under the aegis of Department of Computer Science and Engineering, GSFC University. The chapter aims at serving as a dynamic hub of activities for the computing fraternity of the University, where enthusiasts meet, interact and learn from each other. 
                        ...
                        <ul className="grid gap-6">
                            ...
                            <li>
                                <div className="grid gap-1">
                                    ...
                                    <p className="text-gray-800 dark:text-gray-800">
                                        Become a part of our community to grow your skills and network with like-minded individuals.
                                    </p>
                                </div>
                            </li>
                        </ul>
